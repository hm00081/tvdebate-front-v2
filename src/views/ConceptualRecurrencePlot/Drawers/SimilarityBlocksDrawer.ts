...
export class SimilarityBlocksDrawer {
  ...
  private _clickListener: ((e: MouseEvent, d: SimilarityBlock) => void) | null =
    null;
  ...
  public set standardHighPointOfSimilarityScore(
    ...
    this._standardHighPointOfSimilarityScore =
      standardHighPointOfSimilarityScore;
  }
  ...
  public isSelected(block: SimilarityBlock): boolean {
    return this._selectedBlockIndices.some(
      (indices) =>
        indices[0] === block.rowUtteranceIndex &&
        indices[1] === block.columnUtteranceIndex
    );
  }
    ...
    function fillColorOfSimilarityBlock(
      ...
      if (coloringRebuttal && similarityBlock.refutation) {
        ...
        const adjustedOpacityValues = [
          18.82751331, 6.981868806, 3.869509114, 2.468925094, 1.903323926,
          1.542776171, 1.213284972, 1.088114596, 0.942875687, 0.828912509,
          0.706295081, 0.63287685, 0.591230262, 0.538005371, 0.463493915,
          0.427013104, 0.384948635, 0.34470879, 0.319079873, 0.292835439,
          0.270182682, 0.258855898, 0.250068499, 0.232544626, 0.219586255,
          0.202812561, 0.190284102, 0.174569335, 0.16811274, 0.15309027,
          0.145516623, 0.136490058, 0.129594874, 0.123529022, 0.111817947,
          0.107986048, 0.101794567, 0.093841692, 0.089619484, 0.087219676,
          0.085178754, 0.078508682, 0.071999629, 0.070674205, 0.066783795,
          0.058822291, 0.042814651, 0.038027543, 0.035979082, 0.025598677,
          0.021260026, 0.016818621, 0.01293302, 0.005213995,
