...
export class CP4Drawer extends CPDrawer {
    ...
    public update() {
        ...
        // @ts-ignore
        if ((Array.isArray(highlightedGroup) && highlightedGroup.includes("g4")) ||
          highlightedGroup === "g4") {
        ...
        const filteredPaths = groups.selectAll("path")
            .style("opacity", (d) => {
                ...
                //@ts-ignore
                if (Array.isArray(selectedBlock) && selectedBlock[1]?.length === 0 && Array.isArray(highlightedGroup) && highlightedGroup.includes("g4")) {
                    //@ts-ignore
                ...
                if (selectedBlock.length === 0) {
                    ...
                    if (highlightedGroup === "g4" || !highlightedGroup) {
                        return 1;
                    }
                    return 0.3;
                }
        ...
        CP4Data.forEach((groupData, i) => {
            ...
            const group = this.topicGuideCP4GSelection
                ...
                group.selectAll('*').style('opacity', () => {
                    if (Array.isArray(highlightedGroup)) {
                        //@ts-ignore
                        return highlightedGroup.includes("g4") ? 1 : 0.3;
                    }
                    return highlightedGroup === "g4" || !highlightedGroup ? 1 : 0.3;
                });
                    ...
                    group
                        ...
                        .style('opacity', () => {
                            ...
                            if (Array.isArray(selectedBlock) && selectedBlock.length > 1) {
                                //@ts-ignore
                                if(Array.isArray(selectedBlock[1]) && selectedBlock[1].length === 0 && highlightedGroup.includes("g4")){
                            ...
                            // 🔹 `highlightedGroup`이 배열이면 `includes("g4")`로 체크
                            if (Array.isArray(highlightedGroup)) {
                                //@ts-ignore
                                if (!highlightedGroup.includes("g4")) {
                                    return 0.3;
                            ...
                            // 🔹 `highlightedGroup`이 "g4"일 경우 처리
                            //@ts-ignore
                            if ((Array.isArray(highlightedGroup) && highlightedGroup.includes("g4")) || highlightedGroup === "g4") {
                                if (Array.isArray(selectedBlock) && selectedBlock.length > 1 && Array.isArray(selectedBlock[1])) {
                                    //@ts-ignore
                                    if (selectedBlock[1].length > 1 && 
                                        (selectedBlock[1][0] === element.onClick || selectedBlock[1][1] === element.onClick)) {
                ...
                if (element.type === 'ellipse') {
                    ...
                    group
                        ...
                        .style('opacity', () => {
                            ...
                            // 🔹 highlightedGroup이 배열일 경우 "g4"이 포함되어 있는지 확인
                            if (Array.isArray(highlightedGroup)) {
                                //@ts-ignore
                                if (!highlightedGroup.includes("g4")) {
                                    return 0.3;
                ...
                if (element.type === 'text') {
                    ...
                    text
                      ...
                      .style('opacity', () => {
                        if (highlightedGroup) {
                            //@ts-ignore
                            if(element.content[0].text !== "모병제, 일자리" && element.content[0].text !== "문제 해결책?"
                                //@ts-ignore
                                && element.content[0].text !== "일자리 제공" && element.content[0].text !== "가능한가?"
                                //@ts-ignore
                                && element.content[0].text !== "현 병사의" && element.content[0].text !== "위치는?"
                            ){
                                return 1;
                            }
                          if (Array.isArray(highlightedGroup)) {
